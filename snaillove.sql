...
(NULL, "Skinfood", "Peach Sake Pore Serum", 15, "Description: Rich in Vitamins A, C and Silica Powder derived from rice sake and peach extract, this product is a multi-functional item. Not only does this serum moisture the skin but also helps prevent sebum production while simultaneously minimizing the appearance of pores.", 1, 4),
